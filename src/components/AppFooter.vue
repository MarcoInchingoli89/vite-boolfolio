...
<template>
    <footer class="text-center text-white mt-5 bg-dark">
        <div class="container p-4">
            ...
            <!-- Icone Github e Linkedin -->
            <section class="social_icons d-flex justify-content-center justify-content-around mt-4">
                <a class="btn btn-outline-light btn-floating rounded-circle border border-3" href="#!"
                ...
                <a class="btn btn-outline-light btn-floating rounded-circle border border-3"
                    href="https://github.com/MarcoInchingoli89" target="_blank" role="button"><svg
